        ...
        <div className="container py-5">
          <div className="row">
            <div className="col-lg-8 mx-auto text-center">
              <h1 className="display-4 fw-bold mb-4">О компании Zenith Ltd.</h1>
              <p className="lead">
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6 mb-4 mb-lg-0">
              ...
              <p>
                Zenith Ltd. — это торговая компания, специализирующаяся на поставках электронной компонентной базы (ЭКБ), промышленного оборудования и товаров специального назначения из Китая в Россию.
              </p>
              <p>
